---
title: Kaushik Muduchuru
subtitle: Research Scientist
description: Kaushik Muduchuru, Research Scientist at the Leibniz Centre for Agricultural Landscape Research (ZALF), working on geospatial data science, machine learning, and crop yield forecasting.
...
:::{grid-item}
:columns: 12 12 4 4
:class: profile-photo-col

```{image} professional-dp.png
:alt: Kaushik Muduchuru
:width: 95%
```
...
:::{grid-item}
:columns: 12 12 8 8
:class: profile-info-col

**Kaushik Muduchuru**

Research Scientist · [Leibniz Centre for Agricultural Landscape Research (ZALF)](https://www.zalf.de)

📍 Eberswalder Str. 84, 15374 Müncheberg, Germany

✉️ [kaushik.reddy.m@gmail.com](mailto:kaushik.reddy.m@gmail.com) · (+49) 15510 527370

**Interests:** GeoAI · Machine Learning · Deep Learning · Remote Sensing · Crop Yield Forecasting

[CV (PDF)](cv.pdf)
[Google Scholar](https://scholar.google.com/citations?user=MrB8A3gAAAAJ&hl=en)
[ORCID](https://orcid.org/0000-0002-8967-7872)
[LinkedIn](https://www.linkedin.com/in/kaushik-muduchuru-ab911077/)
[GitHub](https://github.com/kaushikreddym)
